...
% b(q,t) for q=1:Q belief for node t, Q is number of labels a node can have
% F(dq,t) = f(d,t)*b(q,t)
%
...
% T is the number of nodes in the CRF
% D is something I'm not sure of yet...........
% Q is the number of possible labels for a node
[D T] = size(f);
[Q T] = size(b);
